    ...
    async fetch(request, env, ctx) {
        ...
        if (request.method === 'POST' && url.pathname === '/api/deploy') {
            try {
                ...
                kouroshCode = kouroshCode.replace(/@KouroshPanel/gi, '@kouroshasli');
                kouroshCode = kouroshCode.replace(/%40KouroshPanel/gi, '%40kouroshasli');
        ...
        if (request.method === 'POST' && url.pathname === '/api/get-panel-version') {
            try {
                ...
                // روش 1: مستقیماً از API نسخه پنل استفاده کن
                let version = "Unknown";
                let buildId = "";
                if (subdomain) {
                    try {
                ...
                // روش 2: fallback به API محتوای کلودفلر
                if (version === "Unknown") {
                    try {
